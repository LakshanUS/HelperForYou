            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="wrapper-signup">
                    ...
                    <div class="signup-address">
                        <label class="form-text" style="font-size:15px;margin-left: 40px;">Address
                            :</label>&nbsp;&nbsp;&nbsp;
                        <span class="error">
                            <?php echo $addressErr; ?>
                        </span><br />
                ...
                <div class="btn-signup">
                    <button type="submit" name="sign_up_submit" class="btn-signin"><span>Sign Up</span></button>
                </div>
